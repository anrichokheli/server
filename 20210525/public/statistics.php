...
$serverPath = dirname(getcwd());
$totalSpace = disk_total_space($serverPath);
$usedSpace = $totalSpace - disk_free_space($serverPath);
echo "
<p class=textBackground>
...
<p class=textBackground>
<font size=5><b>სერვერის მეხსიერება:</b><br>" . $usedSpace . " ბაიტი / " . $totalSpace . " ბაიტი (" . round(($usedSpace / $totalSpace) * 100, 2) . "%)" . "</font><br>
</p>
";
}
