...
<div id="id01" class="modal">
  ...
  <form class="modal-content">
    <div class="container">
      <h1>გაფრთხილება!</h1>
      <p>ატვირთული მასალის წაშლა უნდა მოხდეს მხოლოდ იმ შემთხვევაში, თუ ის არის შეუსაბამო ან/და ატვირთულია სერვერის გავსების, მუშაობის შეფერხების მიზნით</p>
      <div class="clearfix">
    ...
    <body>
        ...
        function confirmreact() {
            if((document.getElementById("text").value.trim() !== "") && (document.getElementById("preview").innerHTML !== ""))    {
                document.getElementById("reacttext").innerHTML = "რეაგირების ტექსტი: " + document.getElementById("text").value;
